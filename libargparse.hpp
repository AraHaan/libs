...
template<typename T>
void inline libargparse::argreader(int argc, char* argv[], T &array1, T &array2) {
	std::string fn, fn2, consolefilevar, consolefilevar2, custvar_value, Target_Type, tempstr, arg;
	bool custvar_specified, nohead_specified, infile_specified, outfile_specified, Target_Type_specified, use_cs_parse = false;
	if (argc > 2) {
